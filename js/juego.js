...
var Juego = {
    ...
    obstaculosCarretera: [
        //Vallas
        new Obstaculo('imagenes/valla_horizontal.png', 70, 120, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 165, 120, 30, 30, 1),
        ...
        new Obstaculo('imagenes/valla_vertical.png', 600, 80, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 790, 480, 30, 30, 1),
        //Autos
        new Obstaculo('imagenes/auto_verde_abajo.png', 80, 180, 15, 30, 1),
        new Obstaculo('imagenes/auto_verde_derecha.png', 840, 120, 30, 15, 1),
        //Baches
        new Obstaculo('imagenes/bache.png', 165, 380, 40, 40, 1),
        new Obstaculo('imagenes/bache.png', 500, 320, 40, 40, 1),
        new Obstaculo('imagenes/bache.png', 400, 200, 40, 40, 1),
    ],
